...
export const initPagination = (
  ...
  const updatePagination = (total, { page, limit }) => {
    ...
    toRow.textContent = Math.min(page * limit, total); //ЗАМЕНИЛ data.lenght на total, раз мы data не передаем. До какой строки выводим, если это последняя страница, то отображаем оставшееся количество
